...
const LoginResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'error_reason', '3': 4, '4': 1, '5': 11, '6': '.models.ErrorReason', '10': 'errorReason'},
...
const RegisterResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'error_reason', '3': 3, '4': 1, '5': 11, '6': '.models.ErrorReason', '10': 'errorReason'},
  ],
};
...
const RefreshAccessTokenResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'error_reason', '3': 2, '4': 1, '5': 11, '6': '.models.ErrorReason', '10': 'errorReason'},
  ],
};
...
const UserDefinedFields$json = const {
  '1': 'UserDefinedFields',
  '2': const [
    const {'1': 'fields', '3': 1, '4': 3, '5': 11, '6': '.models.UserDefinedFields.FieldsEntry', '10': 'fields'},
  ],
...
const Account$json = const {
  ...
  '2': const [
    ...
    const {'1': 'role', '3': 4, '4': 1, '5': 11, '6': '.models.UserRoles', '10': 'role'},
    ...
    const {'1': 'fields', '3': 9, '4': 1, '5': 11, '6': '.models.UserDefinedFields', '10': 'fields'},
  ],
};
...
const ListAccountsResponse$json = const {
  ...
  '2': const [
    const {'1': 'accounts', '3': 1, '4': 3, '5': 11, '6': '.models.Account', '10': 'accounts'},
...
const SearchAccountsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'search_params', '3': 2, '4': 1, '5': 11, '6': '.models.ListAccountsRequest', '10': 'searchParams'},
  ],
};
...
const SearchAccountsResponse$json = const {
  ...
  '2': const [
    const {'1': 'search_response', '3': 1, '4': 1, '5': 11, '6': '.models.ListAccountsResponse', '10': 'searchResponse'},
  ],
};
...
const AssignAccountToRoleRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'role', '3': 3, '4': 1, '5': 11, '6': '.models.UserRoles', '10': 'role'},
  ],
};
