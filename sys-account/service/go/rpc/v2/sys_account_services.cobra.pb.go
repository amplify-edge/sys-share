...
func _OrgProjServiceNewProjectCommand(cfg *client.Config) *cobra.Command {
	...
	cmd.PersistentFlags().StringVar(&req.LogoFilepath, cfg.FlagNamer("LogoFilepath"), "", "@inject_tag: fake:\"{avatargen:./testdata/generated,128}\" yaml:\"logo_filepath,omitempty\"")
