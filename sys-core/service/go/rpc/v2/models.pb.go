...
type BackupListResult struct {
	...
	BackupFile []*BackupResult `protobuf:"bytes,1,rep,name=backupFile,proto3" json:"backupFile,omitempty"`
}

func (x *BackupListResult) Reset() {
	*x = BackupListResult{}
	if protoimpl.UnsafeEnabled {
...
func (x *BackupListResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BackupListResult) ProtoMessage() {}

func (x *BackupListResult) ProtoReflect() protoreflect.Message {
	mi := &file_models_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BackupListResult.ProtoReflect.Descriptor instead.
func (*BackupListResult) Descriptor() ([]byte, []int) {
	return file_models_proto_rawDescGZIP(), []int{2}
}

func (x *BackupListResult) GetBackupFile() []*BackupResult {
	if x != nil {
		return x.BackupFile
	}
	return nil
...
var file_models_proto_rawDesc = []byte{
	...
	0x76, 0x32, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x1b, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x65, 0x6d, 0x70,
	0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x27, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x74,
	...
	,
...
var file_models_proto_goTypes = []interface{}{
	(*RestoreResult)(nil),    // 0: v2.services.RestoreResult
	(*BackupResult)(nil),     // 1: v2.services.BackupResult
	(*BackupListResult)(nil), // 2: v2.services.BackupListResult
	(*RestoreRequest)(nil),   // 3: v2.services.RestoreRequest
}
var file_models_proto_depIdxs = []int32{
	1, // 0: v2.services.BackupListResult.backupFile:type_name -> v2.services.BackupResult
