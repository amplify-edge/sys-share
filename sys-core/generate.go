...
//go:generate protoc -I./proto/v2/ -I. --dart_out=grpc:./service/flu/lib/rpc/v2/ ./proto/v2/sys_core_models.proto ./proto/v2/sys_core_services.proto ./proto/v2/sys_core_file_services.proto
